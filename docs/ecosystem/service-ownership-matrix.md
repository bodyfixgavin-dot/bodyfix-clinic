...
| BodyFix Pulse｜BodyFix 營運與決策觀測系統 | BodyFix | 營運與決策觀測系統 | BodyFix | developing | `docs/bodyfix-pulse-v1.md`; `app/admin/crm/pulse/`; `components/pulse/`; `lib/pulse/`; `supabase/pulse-v1.sql` | 2026-08-18 | 現階段是 BodyFix CRM 營運節奏模組；不是另一套 CRM 或全生態中央控制台。 |
